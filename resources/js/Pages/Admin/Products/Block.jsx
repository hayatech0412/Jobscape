...
export default function Index({
    ...
    const submit = () => {
        get(route('admin.products.blocked'), {
            onFinish: () => {
            },
        });
    }
        ...
        <AdminAuthLayout>
            <div className="w-[92%] mx-auto mt-[24px] pb-[50px] bg-white border border-gray-200 rounded-lg shadow-md">
                <div className="border-b border-gray-200 px-[4%] py-4">
                    <h3 className=" text-lg font-semibold text-gray-600">ブロック商材一覧</h3>
                </div>
                                ...
                                { products.data.map((product, index) => (
                                    <tr key={product.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="border px-4 py-2">
                                            ...
                                            <button onClick={() => toggleBlockModal((products.current_page - 1) * products.per_page + index + 1, product) } className="ml-2 text-cyan-500 hover:text-blue-700">解除</button>
