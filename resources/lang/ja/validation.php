...
return [
    ...
    */
    ...
    'length'               => ':attributeの長いは:lengthにしてください。',
    'max'                  => [
    ...
    'required_if_accepted' => ':otherが選択された時、:attributeは必須です。',
    ...
    */
    ...
    'attributes' => [
        ...
        'user' => [
            ...
            'status' => 'ステータス',
            'native_city' => '出身市町村',
            'native_high_school' => '出身高校',
            'native_university' => '出身大学',
            'picture' => '写真',
            'current_pref' => '現住所(都道府県)',
            'current_city' => '現住所(市区町村)',
            'marriage_history' => '婚歴',
            'phone' => '電話番号',
