...
import ImageSelect from "@/Components/Companies/ImageSelect";
...
export default function Create() {
    ...
    const [product, setProduct] = useState({
        name: "",
        categories: main_category !== null ? [`${main_category}`] : [],
        custom_category: "",
        ...
        introduction_type: "0",
        reward_type: "1",
        reward_amount_money: 0,
        reward_amount_percent: 0,
        introduction_condition: "",
        introduction_memo: "",
        transaction_period: 0,
        transaction_period_unit: "0",
        schedules: [
            {
                title: "",
                start_amount: "0",
    ...
    const [existCustomCategory, setExistCustomCategory] = useState(false);
    const [nameLength, setNameLength] = useState(25);
    const [isAttachmentsFull, setIsAttachmentsFull] = useState(false);
    ...
    const [isDefaultApproach, setIsDefaultApproach] = useState(true);
    const [benefitsLength, setBenefitsLength] = useState(300);
    const [isDeployFull, setISDeployFull] = useState(false);
    const [isRecuritPeriod, setIsRecuritPeriod] = useState(false);
    ...
    const handleCheckboxChange = (e) => {
        ...
        if (name === "category" || name === "custom_category") {
            if (
                checked &&
    ...
    const handleSelectedImage = (e) => {
        ...
        if (!files.length) return; // ファイルが選択されていない場合は処理をスキップ
        ...
        if (file.size > MAX_FILE_SIZE) {
            alert("ファイルサイズが5MBを超えています。別の画像を選択してください。");
            return;
        }

        const subImageCount = product.attachments.length;
        if (name === "image") {
            setProduct({
                ...product,
                image: files[0].name,
            ...
            setProduct({ ...product, attachments: attachments });
        } else if (name === "detail_image_1") {
            setProduct({
                ...product,
                introduction1: {
    ...
    const handleClickDelete = (name, id) => {
        if (name === "image") {
            setProduct({ ...product, image: "", image_file: undefined });
        } else {
    ...
    useEffect(() => {
        setIsAttachmentsFull(product.attachments.length >= 15);
    ...
    const handleSubmit = (e) => {
        ...
        if (id === "save") {
            ...
            post(route("company.products.draft"));
        }
    };

    return (
        <CompanyAuthLayout>
            <div className="bg-primary md:w-[80%] w-full p-8 rounded mx-auto">
                <h2 className="text-center mb-4 text-white text-2xl font-semibold">
                    出品には審査があります。
                </h2>
                <p className="md:w-[360px] w-full mx-auto font-semibold mt-1 text-white">
                    商材登録後、審査を通過したら自動的に公開されます。
                </p>
                <p className="md:w-[360px] w-full mx-auto font-semibold mt-1 text-white">
                    取引完了目安日は余裕をもって設定してください。
                </p>
            </div>

            <form onSubmit={handleSubmit}>
                <div className="mt-8">
                    <CompanyTitle>商材登録</CompanyTitle>
                </div>
                ...
                <div className="border rounded-lg shadow-lg md:p-12 p-4 bg-white">
                    <div className="flex flex-wrap md:flex-row flex-col items-start justify-start gap-2">
                        <div className="md:w-[200px] w-full">
                            <p className="font-semibold">カテゴリ（必須）</p>
                                    ...
                                    return (
                                        ...
                                        >
                                            <input
                                                ...
                                                checked={product.categories.includes(
                                                    `${category.id}`
                                                )}
                                            />
                                            {category.name}
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-start gap-2">
                        <div className="md:w-[200px] w-full">
                            <p className="font-semibold">商材名（必須）</p>
                        </div>
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-start gap-2">
                        <div className="md:w-[200px] w-full">
                            <p className="font-semibold">メイン画像（必須）</p>
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-start gap-2">
                        ...
                        <div className="flex-1 md:max-w-[600px] w-full">
                            ...
                            {errors.attachments && errors.attachments.image && (
                                <InputError
                                    message={errors.attachments.image}
                                    className="mt-1 text-[12px]"
                                />
                            )}
                            {errors.attachments && errors.attachments.image_file && (
                                <InputError
                                    message={errors.attachments.image_file}
                                    className="mt-1 text-[12px]"
                                />
                            )}
                            ...
                            <div className="mt-4 grid md:grid-cols-5 grid-cols-2 gap-3 w-full">
                                {Array(15)
                                    .fill(0)
                                    .map((_, index) => {
                                        return index < product.attachments.length ? (
                                            <ImageSelect
                                                key={index+product.attachments[index].image}
                                                image={product.attachments[index].image}
                                                image_file={product.attachments[index].image_file}
                                                image_path={product.attachments[index].image_path}
                                                handleClickDelete={() => handleClickDelete("sub_image", index)}
                                            />
                                        ) : (
                                            <div
                                                key={index}
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-start gap-2">
                        <div className="md:w-[200px] w-full">
                            <p className="font-semibold">概要文（必須）</p>
                            <p className="mt-2 text-[12px]">
                                商材・サービス概要
                            </p>
                            <p className="mt-2 text-[12px]">
...
例：当サービスは、高品質なお水の提供やサーバー費用の実質無料特典など、多くの特長があります。業界最高水準のインセンティブ制度を導入しており、同商品を扱う他店より高い紹介手数料をお約束。収入アップを実現しやすい環境を整えています。"
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-start gap-2">
                        <div className="md:w-[200px] w-full">
                            <p className="font-semibold">商材紹介詳細１（必須）</p>
                            <p className="mt-2 text-[12px]">
                                ※中部商材紹介に表示
                            </p>
                            <p className="mt-2 text-[12px]">※1000文字以内</p>
                        </div>
                        ...
                        <div className="flex-1 md:max-w-[850px] w-full">
                            <div className="md:max-w-[600px] w-full">
                                ...
                                {errors["introduction1.image_file"] && (
                                    <InputError
                                        message={errors["introduction1.image_file"]}
                                        className="mt-1 text-[12px]"
                                    />
                                )}
                            ...
                            <div className="mt-4 relative">
                                ...
                                {errors["introduction1.detail_overview"] && (
                                    <InputError
                                        message={ errors["introduction1.detail_overview"] }
                                        className="mt-1 text-[12px]"
                                    />
                                )}
                            </div>
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-start gap-2 mt-8">
                        ...
                        <div className="flex-1 md:max-w-[850px] w-full">
                            <div className="md:max-w-[600px] w-full">
                                ...
                                {errors.introduction2 &&
                                    errors.introduction2.image && (
                                        <InputError
                                            message={errors.introduction2.image}
                                            className="mt-1 text-[12px]"
                                        />
                                    )}
                                {errors.introduction2 &&
                            ...
                            <div className="mt-4 relative">
                                ...
                                {errors.introduction2 &&
                                    errors.introduction2.detail_overview && (
                                        <InputError
                                            message={
                                                errors.introduction2
                                                    .detail_overview
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-start gap-2 mt-16">
                        <div className="md:w-[200px] w-full">
                            <p className="font-semibold">対応地域（必須）</p>
                            <p className="mt-2 text-[12px]">
                                ※商材・サービス提供地域
                            </p>
                        ...
                        <div className="flex-1">
                            <div className="flex flex-wrap items-start justify-start gap-x-8 gap-y-4">
                                ...
                                <div className=" w-full mt-1 flex items-start justify-start gap-4">
                                    <div className="py-3">
                                        <label
                                            htmlFor="海外"
                                            className="flex items-center justify-start gap-1 w-fit"
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-start gap-2">
                        <div className="md:w-[200px] w-full">
                            <p className="font-semibold">サービス対象者（必須）</p>
                            <p className="mt-2 text-[12px]">
                                ※商材の希望紹介先
                            </p>
                        </div>
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-start gap-2">
                        <div className="md:w-[200px] w-full">
                            <p className="font-semibold">営業アプローチ（必須）</p>
                            <p className="mt-2 text-[12px]">
                                ※紹介先への営業手段
                            </p>
                            <p className="mt-2 text-[12px]">※複数選択可</p>
...
例・サービス利用料1ヶ月分無料"
                                ...
                                <div className="flex items-center justify-start gap-2 py-2 mt-2 whitespace-nowrap">
                                    ...
                                    <div>
                                        <input
                                            ...
                                            value={product.capacity_code}
                                            onChange={handleInputChange}
                                        />

                                        {errors.capacity_code && (
                                            <InputError
                                                message={errors.capacity_code}
                                                className="w-full mt-1 text-[12px]"
                                            />
                                        )}
                                    </div>
                ...
                <div className="border rounded-lg shadow-lg md:p-12 p-4 bg-white">
                    <div className="flex md:flex-row flex-col items-start justify-start gap-2 md:p-2 pr-6 relative">
                        <div className="md:w-[200px] w-full">
                            ...
                            <p className="mt-2 text-[12px]">※最大16件まで</p>
                        </div>
                ...
                <div className="border rounded-lg shadow-lg md:p-12 p-4 bg-white">
                    <div className="flex md:flex-row flex-col items-center justify-start gap-2">
                        <div className="md:w-[200px] w-full">
                            <p className="font-semibold">募集期間（必須）</p>
                        </div>
                    ...
                    <div className="flex md:flex-row flex-col items-center justify-start gap-2 mt-4">
                        <div className="md:w-[200px] w-full">
                            <p className="font-semibold">募集件数（必須）</p>
                        </div>
                    ...
                    <div className="flex md:flex-row flex-col items-center justify-start gap-2 mt-4">
                        <div className="md:w-[200px] w-full">
                            <p className="font-semibold">対象紹介会員（必須）</p>
                        </div>
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-start gap-2 py-2 mt-4">
                        <div className="md:w-[200px] w-full">
                            <p className="font-semibold">紹介手数料タイプ（必須）</p>
                            <p className="mt-2 text-[12px]">
                                ※いずれか1つ設定可
                            </p>
                        </div>
                        <div className="flex-1 md:max-w-[900px] w-full">
                            <div className="md:max-w-[600px] w-full">
                                ...
                                <div className="flex items-center justify-between gap-2 mt-4">
                                    <div className="flex-1 flex items-center justify-between gap-2">
                                        ...
                                        <input
                                            ...
                                            value={product.reward_amount_money}
                                            onChange={handleInputChange}
                                ...
                                {errors.reward_amount_percent && (
                                    <InputError
                                        message={errors.reward_amount_percent}
                                        className="mt-1 text-[12px]"
                                    />
                                )}
                            </div>
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-start gap-2 mt-8">
                        <div className="md:w-[200px] w-full">
                            ...
                            <p className="mt-2 text-[12px]">※限定条件など</p>
                        </div>
...
例・ご紹介先が当社サービスに興味を示さない場合は無理な勧誘は行わないようお願いします。"
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-start gap-2 mt-8">
                        ...
                        <div className="flex-1 md:max-w-[850px] w-full">
                            <FaqItemInput
                                ...
                                onChange={handleInputChange}
                                onClickBtn={(id) => handleFaqDelete(id)}
                            />
                            {isEmptyFaq && (
                                <InputError
                                    message="入力してください"
                ...
                <div className="mt-16 flex items-center justify-center gap-4 pb-8">
                    <button
                        type="submit"
                        id="draft"
                        onClick={handleSubmit}
                        className="w-[240px] border border-slate-700 bg-white text-slate-700 px-8 py-4 rounded-full hover:bg-slate-500 hover:text-white hover:border-slate-500"
                    >
                        下書き
                    </button>
                    <button
