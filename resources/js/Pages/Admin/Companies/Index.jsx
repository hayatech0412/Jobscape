...
export default function Index({
    ...
    const submit = () => {
        get(route('admin.companies.accepted'), {
            onFinish: () => {
    ...
    const deleteCompany = () => {
        deleteForm.post(route('admin.companies.delete', [selectedUser.id]), {
            onFinish: () => {
    ...
    return (
        <AdminAuthLayout>
                                ...
                                {users.data.map((user, index) => (
                                    <tr key={user.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="border px-4 py-2">
                                            ...
                                            <Link href={route('admin.companies.edit', [user.id])} className="text-cyan-500 hover:text-blue-700 ml-2">編集</Link>
            ...
            <DeleteModal data={isDeleteSelected} isOpen={isOpenDeleteModal} onClose={toggleModal} onSubmit={deleteCompany} />
        </AdminAuthLayout>
    );
}
