...
export default function MainInfoProprietor({
    Genders,
    Profile,
    prefs,
    user_type
        ...
        <div className="">
            ...
            <div className="border border-gray-200 rounded-md px-[8%] py-[4%] ">
                ...
                <div className="">
                    ...
                    <div className="mb-4">
                        <div className="text-[12px]" >屋号</div>
                        <TextInput
                            type="text"
                            name="business_name"
                        ...
                        <div className="text-[12px] mt-2">金融機関にお届けの名称を入力してください</div>
                    </div>
                    
                    <div className="mb-4">
                        <div className="text-[12px]" >屋号カナ</div>
                        <TextInput
                            type="text"
                            name="business_kana"
                        ...
                        <div className="text-[12px] mt-2">カタカナ入力してください</div>
                    </div>
                </div>
