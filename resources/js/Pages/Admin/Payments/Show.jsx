...
export default function Show({
    ...
    return (
        <AdminAuthLayout> 
            <div className="w-[92%] mx-auto bg-white shadow-lg rounded-lg py-10 mt-8 mb-32">
                <div className="w-[92%] mx-auto ">
                    ...
                    <div className=''>
                        <div className='bg-white rounded-lg shadow-[0_0_10px_0_rgba(0,0,0,0.1)] px-8 py-8 flex mt-4'>
                            <div className='w-1/2'>
                                <img 
                                    className='h-[240px] aspect-video w-full object-cover' 
                                    src={selectedImage} 
                                    alt=""
                                />         
                                <div className='grid gap-3 grid-cols-3 mt-4'>
                                    {product.images.map((image, index) => (
                                        <img onClick={() => setSelectedImage(image)} key={index + "-" + image} className="aspect-video object-cover" src={image} alt="" />
                                    ))}
                                </div>
