...
export default function Edit() {
    ...
    const [product, setProduct] = useState({
        ...
        image_path: originProduct.image_path ? originProduct.image_path : originProduct.thumb_path,
        image_file: undefined,
        attachments: originProduct.attachments ?? [],
        ...
        reward_type: originProduct.reward_type
            ...
            : "1",
        reward_amount_money:
            originProduct.reward_type === 1 ? originProduct.reward_amount : 0,
        reward_amount_percent:
            originProduct.reward_type === 2 ? originProduct.reward_amount : 0,
        introduction_condition: originProduct.introduction_condition ?? "",
        introduction_memo: originProduct.introduction_memo ?? "",
        transaction_period: originProduct.transaction_period ?? 0,
    ...
    const [isAttachmentsFull, setIsAttachmentsFull] = useState(product.attachments.length >= 15);
    ...
    const handleSubmit = (e) => {
        ...
        if (id === "draft") {
            post(route("company.products.update_draft", { product: product.id }));
        } else {
            post(route("company.products.update", { product: product.id }));
        }
    };
                    ...
                    <div className="border rounded-lg shadow-lg md:p-12 p-4 bg-white">
                        ...
                        <div className="flex md:flex-row flex-col items-start justify-start gap-2">
                            ...
                            <div className="flex-1 md:max-w-[600px] w-full">
                                <button
                                    type="button"
                                    className="border border-primary flex items-center justify-center px-8 py-2 rounded-md gap-6 text-primary hover:text-blue-800 hover:border-blue-800"
                                    name="image"
                                    onClick={handleClickImage}
                                >
                                    <div className="relative">
                                        <ImageIcon className="w-[24px] h-[24px] absolute -top-[13px] -right-[18px] fill-[#3370ff] hover:fill-[#1e40af]" />
                                ...
                                <div className="mt-4 grid md:grid-cols-5 grid-cols-1 md:gap-4 gap-2 w-full">
                                    <div className="border rounded-sm aspect-3/2 object-fill relative">
                                        {(product.image_file || product.image_path) && (
                                            <>
                                                <img
                                                    src={product.image_file ? URL.createObjectURL(product.image_file) : product.image_path}
                                                    alt="メイン画像"
                                        ...
                                        return (
                                            ...
                                            >
                                                {index < product.attachments.length && (
                                                    <>
                                                        {product.attachments[index].image_file ? (
                                                            <img
                                                                src={URL.createObjectURL(product.attachments[index].image_file)}
                                                                alt="商材資料"
                                                                className="w-full h-full object-contain"
                                                            />
                                                        ) : (
                                                        ...
                                                        <button
                                                            type="button"
                                                            id={product.attachments[index].index}
                                                            className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-[14px]"
                                                            onClick={(e) => handleClickDelete("sub_image", index)}
                                                        >
                                                            <TrashCanIcon className="w-full hover:fill-[#333333]" />
                                                        </button>
                                                    </>
...
例：当サービスは、高品質なお水の提供やサーバー費用の実質無料特典など、多くの特長があります。業界最高水準のインセンティブ制度を導入しており、同商品を扱う他店より高い紹介手数料をお約束。収入アップを実現しやすい環境を整えています。"
                        ...
                        <div className="flex md:flex-row flex-col items-start justify-start gap-2">
                            ...
                            <div className="flex-1 md:max-w-[850px] w-full">
                                <div className="md:max-w-[600px] w-full">
                                    ...
                                    {(!isEmpty(product.introduction1.image_file) || product.introduction1.image_path) && (
                                        <div className="mt-4 grid md:grid-cols-5 grid-cols-1 md:gap-4 gap-2 w-full">
                                            <div className="border rounded-sm aspect-3/2 object-fill relative">
                                                <>
                                                    <img
                                                        src={
                                                            !isEmpty(product.introduction1.image_file)
                                                                ? URL.createObjectURL(product.introduction1.image_file)
                        ...
                        <div className="flex md:flex-row flex-col items-start justify-start gap-2 mt-8">
                            <div className="md:w-[200px] w-full">
                                <p className="font-semibold">商材紹介詳細２（任意）</p>
                                <p className="mt-2 text-[12px]">
                                    ※中部商材紹介に表示
                                </p>
                                <p className="mt-2 text-[12px]">
                            ...
                            <div className="flex-1 md:max-w-[850px] w-full">
                                <div className="md:max-w-[600px] w-full">
                                    ...
                                    {errors["introduction2.image_file"] && (
                                        <InputError
                                            message={errors["introduction2.image_file"]}
                                            className="mt-1 text-[12px]"
                                        />
                                    )}
                                    ...
                                    <input
                                        ...
                                        onChange={handleSelectedImage}
                                    />
                                    {product.introduction2.image_file || product.introduction2.image_path !== "" && (
                                        <div className="mt-4 grid md:grid-cols-5 grid-cols-1 md:gap-4 gap-2 w-full">
                                            <div className="border rounded-sm aspect-3/2 object-fill relative">
                                                    <>
                                                        <img
                                                            src={
                                                                product.introduction2.image_file !== undefined
                                                                    ? URL.createObjectURL(product.introduction2.image_file)
