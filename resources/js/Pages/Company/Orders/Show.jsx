                    ...
                    <CustomCard title="対応状況">
                        ...
                        <div className="mb-12">
                            ...
                            >
                                ...
                                {
                                    proposeForm.data.editable && <div className="flex justify-between mt-8">
                                        <button 
                                            className="border border-full border-gray-500 text-gray-500 flex-1 mr-2 py-2 rounded-full">
                                            キャンセル
                                        </button>
                                        <button 
                                            onClick={() => proposeUpdate()} 
                                            className="bg-primary text-white flex-1 ml-2 py-2 rounded-full">
                                            保存
                                        </button>
                                    </div>
                                }
                            ...
                            >
                                ...
                                {
                                    firstStepForm.data.editable && <div className="flex justify-between mt-8">
                                        <button 
                                            onClick={() => handleSetData(firstStepForm, 'editable', false)} 
                                            className="border border-full border-gray-500 text-gray-500 flex-1 mr-2 py-2 rounded-full">
                                            キャンセル
                                        </button>
                                        <button 
                                            onClick={() => firstStepFormSubmit()} 
                                            className="bg-primary text-white flex-1 ml-2 py-2 rounded-full">
                                            保存
                                        </button>
                                    </div>
                            ...
                            >
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="mt-6 border-t-2 border-primary p-2 px-4 bg-gray-100 pb-12">
                                        ...
                                        <label htmlFor="file" className="bg-white mt-4 relative w-full py-3 text-md text-primary text-center flex items-center justify-center border border-blue-600 rounded-full cursor-pointer">
                                            <input 
                                                disabled={!secondStepForm.data.editable || secondStepForm.data.value != 1} 
                                                onChange={(e) => handleSetData(secondStepForm, 'file', e.target.files[0])}
                                ...
                                {
                                    secondStepForm.data.editable &&
                                        <div className="flex justify-between mx-4 mt-8">
                                            <button className="border border-full border-gray-500 text-gray-500 flex-1 mr-1 md:mr-4 py-1 md:py-3 rounded-full">キャンセル</button>
                                            <button onClick={successOrFail} className="bg-primary text-white flex-1 ml-1 md:ml-4 py-1 md:py-3 rounded-full">保存する</button>
                                        </div>
                                }
                            </StatusAccordian>
                            <StatusAccordian
                            ...
                            >
                                ...
                                {
                                    thirdStepForm.data.editable && <div className="flex justify-between mt-8">
                                        <button className="border border-full border-gray-500 text-gray-500 flex-1 mr-0 md:mr-2 py-2 rounded-full">キャンセル</button>
                                        <button 
                                            disabled={!thirdStepForm.data.editable}
                                            onClick={reportPayed}
                                            className="bg-primary text-white flex-1 ml-0 md:ml-2 py-2 rounded-full">
                                            保存
                                        </button>
                                    </div>
                                }
